...
export const plans = [
  {
    ...
    featured: true,
    badge: "Most Popular",
    tagline: "Exceptional lifestyle, zero red flags",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "Low",
    featured: false,
    tagline: "Very healthy, safe driver",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "Slight",
    featured: false,
    tagline: "Slightly above average, minor risks",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "Moderate",
    featured: false,
    tagline: "Average Indian middle-class profile",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "Elevated",
    featured: false,
    tagline: "Multiple lifestyle risk factors",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "High",
    featured: false,
    tagline: "High risk — smoker, poor metrics, erratic driving",
    period: "/month",
  ...
  },
  {
    ...
    riskLevel: "Very High",
    featured: false,
    tagline: "Severe risk — near uninsurable by traditional standards",
    period: "/month",
